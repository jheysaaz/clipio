  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-zinc-100 text-zinc-900 hover:bg-zinc-100/80 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-800/80",
        destructive:
        ...
        outline: "text-zinc-950 dark:text-zinc-200",
      },
    },
    defaultVariants: {
      variant: "default",
